...
const uint8 F14x16[] = {
  ...
  0x00,0x00,0x04,0x04,0x7C,0x8C,0x14,0x24,0x84,0x74,0x0C,0x00,0x00,0x00,0x00,0x00,
  0x40,0x20,0x20,0x11,0x0E,0x0E,0x11,0x30,0x20,0x40,0x40,0x00,/*"叉",0*/


  0x00,0x00,0x08,0xC8,0x38,0x0C,0x0A,0xE8,0x08,0x08,0x88,0x08,0x00,0x00,0x00,0x08,
  0x08,0x09,0x09,0x09,0x09,0x7F,0x09,0x09,0x08,0x08,0x08,0x00,/*"车",1*/

  
  0x00,0x00,0xFC,0x44,0xB4,0x0C,0x00,0x00,0xFE,0xC0,0x00,0x00,0x00,0x00,0x00,0x00,
  0x3F,0x08,0x58,0x2F,0x10,0x0E,0x01,0x03,0x0C,0x30,0x00,0x00,/*"队",2*/
...
void OLED_Init(void)
{
  ...
  OLED_Set_Pos(0,0);
   ...
   OLED_Fill(0x00);//黑屏 
   OLED_DLY_ms(1500); 
  /* OLED_Print(5,0,"SUES_叉车队");  //汉字字符串显示
   OLED_Print(5,2,"SUES_叉车队");  //汉字字符串显示
   OLED_Print(5,4,"SUES_叉车队");  //汉字字符串显示
   OLED_Print(5,6,"SUES_叉车队");  //汉字字符串显示*/
